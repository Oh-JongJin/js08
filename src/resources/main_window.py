...
"color: rgb(255, 255, 255);")
        ...
        self.monitoring_label.setMinimumSize(QSize(0, 50))
        font1 = QFont()
        font1.setFamilies([u"Noto Sans"])
        font1.setPointSize(30)
        self.monitoring_label.setFont(font1)
...
"background-color: #1b3146;")
        icon1 = QIcon()
        icon1.addFile(u"asset/alert.png", QSize(), QIcon.Normal, QIcon.Off)
        self.maxfev_alert.setIcon(icon1)
...
"background-color: #1b3146;")
        icon2 = QIcon()
        icon2.addFile(u"asset/green.png", QSize(), QIcon.Normal, QIcon.Off)
        self.alert.setIcon(icon2)
...
"background-color: #1b3146;")
        icon3 = QIcon()
        icon3.addFile(u"asset/settings.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.camera_verticalLayout.addLayout(self.monitoring_horizontalLayout)
        ...
        sizePolicy3.setHeightForWidth(self.label_6hour.sizePolicy().hasHeightForWidth())
        self.label_6hour.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.label_6hour_time.sizePolicy().hasHeightForWidth())
        self.label_6hour_time.setSizePolicy(sizePolicy4)
        font2 = QFont()
...
"color:#ffffff;")
        ...
        sizePolicy3.setHeightForWidth(self.label_5hour.sizePolicy().hasHeightForWidth())
        self.label_5hour.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.label_5hour_time.sizePolicy().hasHeightForWidth())
        self.label_5hour_time.setSizePolicy(sizePolicy4)
...
"color:#ffffff;")
        ...
        sizePolicy3.setHeightForWidth(self.label_4hour.sizePolicy().hasHeightForWidth())
        self.label_4hour.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.label_4hour_time.sizePolicy().hasHeightForWidth())
        self.label_4hour_time.setSizePolicy(sizePolicy4)
...
"color:#ffffff;")
        ...
        sizePolicy3.setHeightForWidth(self.label_3hour.sizePolicy().hasHeightForWidth())
        self.label_3hour.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.label_3hour_time.sizePolicy().hasHeightForWidth())
        self.label_3hour_time.setSizePolicy(sizePolicy4)
...
"color:#ffffff;")
        ...
        sizePolicy3.setHeightForWidth(self.label_2hour.sizePolicy().hasHeightForWidth())
        self.label_2hour.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.label_2hour_time.sizePolicy().hasHeightForWidth())
        self.label_2hour_time.setSizePolicy(sizePolicy4)
...
"color:#ffffff;")
        ...
        sizePolicy3.setHeightForWidth(self.label_1hour.sizePolicy().hasHeightForWidth())
        self.label_1hour.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.label_1hour_time.sizePolicy().hasHeightForWidth())
        self.label_1hour_time.setSizePolicy(sizePolicy4)
...
"background-color: #1b3146;")
        icon4 = QIcon()
        icon4.addFile(u"asset/graph.png", QSize(), QIcon.Normal, QIcon.Off)
        self.timeseries_button_2.setIcon(icon4)
...
"background-color: #1b3146;")
        icon5 = QIcon()
        icon5.addFile(u"asset/polar.png", QSize(), QIcon.Normal, QIcon.Off)
        self.timeseries_button.setIcon(icon5)
...
"background-color: #1b3146;")
        icon6 = QIcon()
        icon6.addFile(u"asset/clock.png", QSize(), QIcon.Normal, QIcon.Off)
        self.time_button.setIcon(icon6)
...
"background-color: #1b3146;")
        icon7 = QIcon()
        icon7.addFile(u"asset/vis.png", QSize(), QIcon.Normal, QIcon.Off)
        self.prevailing_vis_button.setIcon(icon7)
        ...
        icon8 = QIcon()
        icon8.addFile(u"asset/pre_vis_1.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button.setIcon(icon8)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.monitoring_label.setText(QCoreApplication.translate("MainWindow", u"   Monitoring", None))
