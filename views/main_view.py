...
from PyQt5.QtCore import Qt, pyqtSignal, pyqtSlot  # pylint: disable=no-name-in-module
...
# js06 modules
from views.video_widget import Js06VideoWidget
...
class Js06MainView(QMainWindow):
    ...
    def restore_default(self):
        ...
        self.set_normal_shutdown.emit(False)
    # end of restore_default
